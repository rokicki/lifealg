...
const int shift = 7 ;
class sse2algo : public lifealgo {
public:
...
static class sse2algofactory : public lifealgofactory {
public:
   sse2algofactory() ;
...
sse2algofactory::sse2algofactory() {
   registerAlgo("sse2", &factory) ;
}
void sse2algo::init(int w_, int h_) {
   w = w_ ;
   h = h_ ;
...
void sse2algo::setcell(int x, int y) {
...
void sse2algo::swap() { ::swap(u0, u1) ; }
int sse2algo::nextstep(int id, int n, int needpop) {
   int r = 0 ;
